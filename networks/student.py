...
class STMobileNetV2_unet(nn.Module):
    def __init__(self, pre_trained='weights/mobilenet_v2.pth.tar', mode='train'):
        super(STMobileNetV2_unet, self).__init__()
...
if __name__ == '__main__':
    ...
    net = MobileNetV2_unet(pre_trained=None)
    y,middle_feature1,middle_feature2 = net(x)
